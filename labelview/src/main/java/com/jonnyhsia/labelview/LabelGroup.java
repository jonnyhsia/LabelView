...
public class LabelGroup extends ViewGroup {
    ...
    private int mDividerPaddingSecondary;
    private int mDividerPaddingSecondaryEnd;
    ...
    public LabelGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LabelGroup, defStyleAttr, 0);

        int index = a.getInt(R.styleable.LabelGroup_android_orientation, -1);
        setOrientation(index >= 0 ? index : VERTICAL);

        // index = a.getInt(R.styleable.LabelGroup_android_gravity, -1);
        // if (index >= 0) {
        setGravity(index);
        // }

        boolean baselineAligned = a.getBoolean(R.styleable.LabelGroup_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }

        mWeightSum = a.getFloat(R.styleable.LabelGroup_android_weightSum, -1.0f);

        mBaselineAlignedChildIndex =
                a.getInt(R.styleable.LabelGroup_android_baselineAlignedChildIndex, -1);

        mUseLargestChild = a.getBoolean(R.styleable.LabelGroup_measureWithLargestChild, false);

        setDividerDrawable(a.getDrawable(R.styleable.LabelGroup_labelDivider));
        mShowDividers = a.getInt(R.styleable.LabelGroup_showLabelDividers, SHOW_DIVIDER_NONE);
        mDividerPadding = a.getDimensionPixelSize(R.styleable.LabelGroup_labelDividerPadding, 0);
        mDividerPaddingSecondary = a.getDimensionPixelSize(R.styleable.LabelGroup_labelDividerPaddingSecondary, 0);
        mDividerPaddingSecondaryEnd = a.getDimensionPixelSize(R.styleable.LabelGroup_labelDividerPaddingSecondaryEnd, 0);
    ...
    void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child != null && child.getVisibility() != GONE) {
                if (hasDividerBeforeChildAt(i)) {
                    ...
                    boolean show = isFirst | lp.showDivider;
                    if (show) {
                        drawHorizontalDividerCompat(canvas, top, isFirst);
                    }
                    isFirst = false;
                }
            }
        ...
        if (hasDividerBeforeChildAt(count)) {
            ...
            drawHorizontalDividerCompat(canvas, bottom, true);
        }
    }
    ...
    void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child != null && child.getVisibility() != GONE) {
                if (hasDividerBeforeChildAt(i)) {
                    ...
                    if (lp.showDivider) {
                        drawVerticalDividerCompat(canvas, position, isFirst);
                    }
                    isFirst = false;
                }
            }
        ...
        if (hasDividerBeforeChildAt(count)) {
            ...
            drawVerticalDividerCompat(canvas, position, false);
        }
    }
    ...
    void drawHorizontalDividerCompat(Canvas canvas, int top, boolean isEdge) {
        int divPadding = isEdge ? mDividerPadding : mDividerPaddingSecondary;
        int divPaddingEnd = isEdge ? mDividerPadding : mDividerPaddingSecondaryEnd;

        mDivider.setBounds(getPaddingLeft() + divPadding, top,
                getWidth() - getPaddingRight() - divPaddingEnd, top + mDividerHeight);
        mDivider.draw(canvas);
    }

    void drawVerticalDividerCompat(Canvas canvas, int left, boolean isEdge) {
        int divPadding = isEdge ? mDividerPadding : mDividerPaddingSecondary;
        int divPaddingEnd = isEdge ? mDividerPadding : mDividerPaddingSecondaryEnd;
        mDivider.setBounds(left, getPaddingTop() + divPadding,
                left + mDividerWidth, getHeight() - getPaddingBottom() - divPaddingEnd);
        mDivider.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        LabelGroup.LayoutParams lp = (LabelGroup.LayoutParams) child.getLayoutParams();
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (useLargestChild &&
            ...
            for (int i = 0; i < count; ++i) {
                ...
                final LabelGroup.LayoutParams lp = (LabelGroup.LayoutParams)
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
            ...
            if (useLargestChild && heightMode != MeasureSpec.EXACTLY) {
                for (int i = 0; i < count; i++) {
                    ...
                    final LabelGroup.LayoutParams lp =
                            (LabelGroup.LayoutParams) child.getLayoutParams();
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new LabelGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof LabelGroup.LayoutParams;
    }

    @Override
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        super.onInitializeAccessibilityEvent(event);
        event.setClassName(LabelGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(LabelGroup.class.getName());
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.LabelGroup_Layout);

            weight = a.getFloat(R.styleable.LabelGroup_Layout_android_layout_weight, 0);
            gravity = a.getInt(R.styleable.LabelGroup_Layout_android_layout_gravity, -1);
            showDivider = a.getBoolean(R.styleable.LabelGroup_Layout_showDivider, true);
